...
delete mp;
this.createEmptyMovieClip("mc_bgSound_race",this.getNextHighestDepth());
this.createEmptyMovieClip("mc_bgSound",this.getNextHighestDepth());
this.createEmptyMovieClip("mc_orgel",this.getNextHighestDepth());
S_ljubel = new Sound(this);
S_bgSound = new Sound(mc_bgSound);
S_orgel = new Sound(mc_orgel);
S_bgSound_race = new Sound(mc_bgSound_race);
S_goalSound = new Sound(this);
S_speaker_idle1 = new Sound(this);
S_speaker_idle2 = new Sound(this);
S_ljubel.attachSound("ljubel");
S_bgSound.attachSound("bgSound");
S_orgel.attachSound("orgel");
S_goalSound.attachSound("goalSound");
S_speaker_idle1.attachSound("speaker_idle1");
S_speaker_idle2.attachSound("speaker_idle2");
S_bgSound.start(0,10000);
S_bgSound_race.start(0,99999);
S_orgel.start(0,99999);
S_orgel.setVolume(80);
