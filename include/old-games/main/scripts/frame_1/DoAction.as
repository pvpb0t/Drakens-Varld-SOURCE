...
delete mp;
urlArr = new Array("/svt/jsp/Crosslink.jsp?d=41035&a=446642","/svt/jsp/Crosslink.jsp?d=41035&a=267373","/svt/jsp/Crosslink.jsp?d=41035&a=446638","/svt/jsp/Crosslink.jsp?d=41035&a=446629","/svt/jsp/Crosslink.jsp?d=41035&a=446639");
obj1Y = obj1._y;
obj2Y = obj2._y;
obj3Y = obj3._y;
obj4Y = obj4._y;
...
obj4_b._alpha = 0;
obj5_b._alpha = 0;
obj1_b._visible = false;
obj2_b._visible = false;
obj3_b._visible = false;
obj4_b._visible = false;
obj5_b._visible = false;
obj1.tween("_y",obj1Y,1,"easeOutback",0,function()
{
   obj1_b._visible = true;
}
);
obj2.tween("_y",obj2Y,1,"easeOutback",0.3,function()
{
   obj2_b._visible = true;
}
);
obj3.tween("_y",obj3Y,1,"easeOutback",0.6,function()
{
   obj3_b._visible = true;
}
);
obj4.tween("_y",obj4Y,1,"easeOutback",0.9,function()
{
   obj4_b._visible = true;
}
);
obj5.tween("_y",obj5Y,1,"easeOutback",1.2,function()
{
   obj5_b._visible = true;
}
);
i = 1;
while(i < 6)
{
   this["obj" + i].onRelease = function()
   {
      getURL("javascript:SgOpenArgs(\'" + urlArr[this._name.substr(3,4) - 1] + "\',\'gamlaspel\', \'480\',\'480\',\'scrollbars=no\');","");
   };
   this["obj" + i].onRollOver = function()
   {
      eval(this._name + "_b").alphaTo(70,0.5,"easeoutquart");
   };
   this["obj" + i].onRollOut = function()
   {
      eval(this._name + "_b").alphaTo(0,0.5,"easeoutquart");
   };
   i++;
}
